...
// TODO: с размером заметки происходит какая то фигня
// TODO: ЗАМЕТКА: выбор цвета для: заголовка и тела заметки (взять из панели кнопку)
// TODO: НАТСРОЙКИ-ЗАМЕТКА: выбор цвета для: заголовка и тела заметки (взять из панели кнопку)
// Лучше вообще почти все или все взять у старого менежера
// TODO: Если закрывать заметки, то с флагом, показывает окно подтверждения "Действительно выйти?"
